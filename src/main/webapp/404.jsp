...
<html>
    <head>
        ...
        <title><%=Constant.NAMEAPP%>: ERROR 404</title>
    ...
    <body>
        ...
        <div class="text">
            <h1>ERRORE 404</h1>  
            <h3>La pagina/risorsa richiesta non &#232; stata trovata. <a href="login.jsp">Clicca qui</a> per essere reindirizzato alla pagina di LOGIN.</h3> 
        </div>
    </body>
