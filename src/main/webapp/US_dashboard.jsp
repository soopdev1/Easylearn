                                            ...
                                            <a href="#" class="card bg-body h-150px">
                                                ...
                                                <div class="card-body d-flex flex-column justify-content-between">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="text-muted fw-bold fs-6">Istanze Inviate</div>
                                                    </div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <a href="#" class="card bg-body h-150px">
                                                ...
                                                <div class="card-body d-flex flex-column justify-content-between">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <div class="d-flex flex-column">
                                                        <div class="text-dark fw-bolder fs-1 mb-0 mt-5"><%=contatori[2]%></div>
                                                        <div class="text-muted fw-bold fs-6">Corsi avviati</div>
                                                    </div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <a href="#" class="card bg-body h-150px">
                                                ...
                                                <div class="card-body d-flex flex-column justify-content-between">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <div class="d-flex flex-column">
                                                        <div class="text-success fw-bolder fs-1 mb-0 mt-5"><%=contatori[3]%></div>
