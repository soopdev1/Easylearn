    ...
    <%
        ...
        switch (verifysession) {
            case 1: {
                ...
                Corsoavviato is1 = eo.getEm().find(Corsoavviato.class, idc1);
                List<Allegati> la = eo.list_allegati(null, null, is1, null, null, null);
    %>
    <!--begin::Head-->
    <head><base href="">
        <title><%=Constant.NAMEAPP%>: Rigetta richiesta cambio sede</title>
        <meta charset="utf-8" />
                            ...
                            <div class="row g-10">
                                ...
                                <div class="row g-5 g-lg-10">
                                    ...
                                    <form action="Operations" method="POST">
                                        <input type="hidden" name="type" value="RIGETTACAMBIOSEDE" /> 
                                        <input type="hidden" name="idcorso" value="<%=idc1%>" /> 
                                            ...
                                            <div class="row form-control">
                                                ...
                                                <div class="form-group" id="abilitasoccorso">
                                                    ...
                                                    <div class="alert alert-warning">
                                                        NON &#200; PRESENTE DOCUMENTAZIONE ALLEGATA AL CORSO. IL SOGGETTO DOVR&#192; CARICARE NUOVA DOCUMENTAZIONE.
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label>Inserire indicazioni per il Soggetto Proponente o la motivazione del rigetto cambio sede</label>
                                                    <textarea name="motivazione"></textarea>
                                                </div>
                                                <hr>
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-large btn-primary"><i class="fa fa-save"></i> Salva Dati e Rigetta richiesta cambio sede</button>
                                                </div>
                                            </div>
                                            <!--begin::Table container-->
                                        </div> 
