...
<html lang="en">
    ...
    <!--begin::Head-->
    <head><base href="">
        <title><%=Constant.NAMEAPP%>: Upload D.A. firmato</title>
        <meta charset="utf-8" />
                        ...
                        <div class="flex-column flex-column-fluid container-fluid">
                            ...
                            <div class="content flex-column-fluid" id="kt_content">
                                ...
                                <div class="card h-xl-50">
                                    ...
                                    <form action="Operations?type=UPLDECAUT" method="post"  enctype="multipart/form-data">
                                        <input type="hidden" name="idist" value="<%=is1.getIdistanza()%>"/>

                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3 mb-1">UPLOAD DECRETO AUT. FIRMATO</span>
                                            </h3>
                                        ...
                                        <div class="card-body py-3">
                                            <div class="row row-border col-md-12 p-5">
                                                <label class="col-lg-4 col-form-label fw-bold fs-6" >
                                                    <span class="text-info"><b>D.D.S. NUMERO</b></span>
                                                </label>
                                                <div class="col-md-8 fv-row">
                                                    <input type="text" name="DDSNUMERO" id="DDSNUMERO"
                                            ...
                                            <div class="row row-border col-md-12 p-5">
                                                <label class="col-lg-4 col-form-label fw-bold fs-6" >
                                                    <span class="text-info"><b>D.D.S. DATA</b></span>
                                                </label>
                                                <div class="col-md-8 fv-row">
                                                    <input type="date" name="DDSDATA" id="DDSDATA"
