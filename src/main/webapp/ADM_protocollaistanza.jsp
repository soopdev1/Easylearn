    ...
    <%
        ...
        switch (verifysession) {
            case 1: {
                ...
                String prot_num = (is1.getProtocolloreg() == null) ? "" : is1.getProtocolloreg();
                String prot_dat = (is1.getProtocolloregdata() == null) ? "" : is1.getProtocolloregdata();
        ...
        <div id="kt_content">
            ...
            <div class="row">
                ...
                <div class="row card-lg-stretch">
                    ...
                    <!--begin::Col-->
                    <div class="card-body">
                        <form class="form-control" action="Operations" method="POST">
                            <input type="hidden" name="type" value="PROTOCOLLAISTANZA" /> 
                            <input type="hidden" name="idist" value="<%=idist%>" /> 
                            <div class="card-body border-0">
                                <div class="row row-border">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-bold fs-6" >
                                        <span class="text-info"><b>PROTOCOLLO NUMERO</b></span>
                                    </label>
                                    <label class="col-lg-8 col-form-label fw-bold fs-6">
                                        <input type="text" name="prot_num" id="prot_num" value="<%=prot_num%>" class="form-control" required />
                                    </label>
                                </div>
                                <div class="row row-border">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-bold fs-6" >
                                        <span class="text-info"><b>PROTOCOLLO DATA</b></span>
                                    </label>
                                    <label class="col-lg-8 col-form-label fw-bold fs-6">
                                        <input type="date" name="prot_dat" id="prot_dat" value="<%=prot_dat%>" class="form-control" required />
                                    </label>
                                </div>

                                <hr>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-large btn-success"><i class="fa fa-save"></i> Salva Dati</button>
                                </div>
