...
<html lang="en">
    ...
    <!--begin::Head-->
    <head><base href="">
        <title><%=Constant.NAMEAPP%>: Nota di nomina presidente commissione d'esame</title>
        <meta charset="utf-8" />
                ...
                <div class="col-xl-12">
                    <div class="card h-xl-100">
                        ...
                        <div class="card-body py-3">
                            ...
                            <%if (is1.getProtnomina() != null) {%>
                            <hr>
                            <div class="row col-md-12">
                                <label class="col-md-3 col-form-label fw-bold fs-6">
                                    <span class="text-danger">NUMERO PROTOCOLLO NOTA NOMINA:</span>
                                </label>
                                <div class="col-md-3  col-form-label fw-bold fs-6">
                                    <span class="text-black"><b><%=is1.getProtnomina()%></b></span>
                                </div>
                                <label class="col-md-3 col-form-label fw-bold fs-6">
                                    <span class="text-danger">DATA PROTOCOLLO NOTA NOMINA:</span>
                                </label>
                                <div class="col-md-3  col-form-label fw-bold fs-6">
                                    <span class="text-black"><b><%=Constant.sdf_PATTERNDATE4.format(is1.getDataprotnomina())%></b></span>
                                </div>
                            </div>
                            <%} else {%>
                            <hr>
                            ...
                            <div class="row col-md-12">
                                <form method="POST" action="Operations" target="_blank">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm col-md-1"
                                            data-bs-toggle="tooltip" title="VISUALIZZA NOTA NOMINA" 
                                            data-preload='false'> <i class="fa fa-file-alt" ></i></button>
                                </form>
                            </div>
                            <%}%>
