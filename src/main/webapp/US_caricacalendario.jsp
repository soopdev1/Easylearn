                            ...
                            <div class="row g-10">
                                ...
                                <div class="row g-5 g-lg-10">
                                    ...
                                    <div class="card-body py-3">
                                        ...
                                        <form action="Operations" method="POST" onsubmit="return false;">
                                            <input type="hidden" name="type" value="ADDCALENDARIO" />
                                            ...
                                            <table class="table table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col"><b>Ora Inizio</b></th>
                                                        <th scope="col"><b>Ora fine</b></th>
                                                        <th scope="col"><b>Docente</b></th>
                                                        <th scope="col"><b>Tipo Lezione</b></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <%for (int i = 1; i <= 10; i++) {%>
                                                    <tr>
                                                        ...
                                                        <td>                                                            
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="date" name="datalez_<%=i%>" 
                                                        ...
                                                        <td>                                                            
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="time" name="iniziolez_<%=i%>" 
                                                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" 
                                                                           required/>
                                                                </div>
                                                                <!--end::Col-->
                                                        ...
                                                        <td>                                                            
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="time" name="finelez_<%=i%>" 
                                                                           class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" 
                                                                           required/>
                                                                </div>
                                                                <!--end::Col-->
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <select aria-label="Scegli..." data-control="select2" data-placeholder="Scegli..." 
                                                                            class="form-select form-select-solid form-select-lg fw-bold" name="docente_<%=i%>" required>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <select aria-label="Scegli..." data-control="select2" data-placeholder="Scegli..." 
                                                                            class="form-select form-select-solid form-select-lg fw-bold" name="docente_<%=i%>" required>
                                                                        <option value="">Scegli...</option>
                                                                        <option value="A">In Presenza</option>
                                                                        <option value="B">FAD</option>
                                                                    </select>
                                                                </div>
                                                                <!--end::Col-->
                                                                <!--begin::Col-->
