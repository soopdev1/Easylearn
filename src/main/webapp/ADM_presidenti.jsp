...
<html lang="en">
    ...
    <!--begin::Head-->
    <head><base href="">
        <title><%=Constant.NAMEAPP%>: Elenco Presidenti di Commissione</title>
        <meta charset="utf-8" />
    ...
    <body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed">
                                        ...
                                        <div class="card h-xl-100">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bolder fs-3 mb-1">ELENCO PRESIDENTI DI COMMISSIONE</span>
                                                </h3>
                                                    ...
                                                    <table class="table align-middle gy-3 table-bordered table-hover" id="tab_dt1">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="p-2">Qualifica</th>
                                                                <th class="p-2">Dipartimento</th>
        ...
        <script type="text/javascript" src="assets/js/ADM_presidenti.js"></script>
