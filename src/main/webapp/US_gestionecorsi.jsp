    ...
    <%
        ...
        switch (verifysession) {
            case 1: {
                ...
                List<Corsoavviato> corsi = e.getCorsiAvviati(session);
    %>
    <!--begin::Head-->
    <head><base href="">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=stato%></td>
                                                        <td>
                                                            <a href="#" class="btn btn-sm btn-bg-light btn-primary" data-bs-toggle="tooltip" title="VISUALIZZA ISTANZA" 
                                                            ...
                                                            <a href="US_caricacalendario.jsp?idcorso=<%=co1.getIdcorso()%>" data-fancybox data-type='iframe' 
                                                               data-bs-toggle="tooltip" title="CARICA CALENDARIO CORSO" 
                                                               data-preload='false' data-width='75%' data-height='75%' 
                                                               class="btn btn-sm btn-bg-light btn-dark fan1">
                                                                <i class="fa fa-calendar"></i></a>

                                                            <a href="US_caricapresenze.jsp?idcorso=<%=co1.getIdcorso()%>" data-fancybox data-type='iframe' 
                                                               data-bs-toggle="tooltip" title="CARICA PRESENZA ALLIEVI " 
                                                               data-preload='false' data-width='100%' data-height='100%' 
                                                               class="btn btn-sm btn-bg-light btn-warning fan1">
                                                                <i class="fa fa-clock"></i></a>


                                                            <a href="#" class="btn btn-sm btn-bg-light btn-success" data-bs-toggle="tooltip" title="CONCLUDI CORSO - RICHIEDI ESAME FINALE" 
                                                               onclick="return document.forms['concl_<%=co1.getIdcorso()%>'].submit();" >
                                                            ...
                                                            <form action="Operations" method="POST" name="concl_<%=co1.getIdcorso()%>">
                                                                <input type="hidden" name="type" value="CONCLUDICORSO" />
                                                                <input type="hidden" name="idcorso" value="<%=co1.getIdcorso()%>" />
                                                            </form>
                                                        </td>
                                                    </tr>  
                                                    <% }%>
