<%-- 
    Document   : 404
    Created on : 13 lug 2023, 16:30:12
...
<html>
    ...
    <body>
        ...
        <div class="text">
            <h1>ERRORE 500</h1>  
            <h3>La pagina/risorsa richiesta ha generato un errore inatteso. Contattare l'amministratore di sistema. <a href="login.jsp">Clicca qui</a> per essere reindirizzato alla pagina di LOGIN.</h3> 
        </div>
    </body>
