...
<html lang="en">
    ...
    <!--begin::Head-->
    <head><base href="">
        <title><%=Constant.NAMEAPP%>: Rigetta Avvio Corso</title>
        <meta charset="utf-8" />
                            ...
                            <div class="row g-10">
                                ...
                                <div class="row g-5 g-lg-10">
                                    ...
                                    <form action="Operations" method="POST">
                                        <input type="hidden" name="type" value="RIGETTACORSO" /> 
                                        ...
                                        <div class="card-body border-0 pt-5">
                                            <div class="row form-control">
                                                ...
                                                <hr>
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-large btn-primary"><i class="fa fa-save"></i> Salva Dati e Rigetta Corso</button>
                                                </div>
                                            </div>
                                            <!--begin::Table container-->
                                        </div> 
